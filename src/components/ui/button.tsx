...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        'gradient-button text-white hover:shadow-lg focus-visible:ring-[var(--primary)]',
      secondary:
        'bg-[var(--background-secondary)] text-[var(--foreground)] hover:bg-[var(--background-tertiary)] border border-[var(--border)] focus-visible:ring-[var(--border)]',
      ghost:
        'text-[var(--foreground)] hover:bg-[var(--background-secondary)] focus-visible:ring-[var(--border)]',
      outline:
